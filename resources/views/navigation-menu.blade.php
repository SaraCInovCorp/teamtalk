<nav x-data="{ open: false }" class="bg-teamtalk-blue shadow-md">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-26">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ auth()->check() ? route('dashboard') : route('home') }}">
                        <img src="{{ asset('logo.png') }}" alt="TeamTalk - Chat para Equipes" class="w-26 h-24 object-contain mx-auto"/>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                    <button class="flex text-sm border-2 border-white shadow-sm rounded-full focus:outline-none focus:border-gray-300 transition">
                ...
                @else
                <!-- Parte para visitantes (não autenticados) -->
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('register') }}" class="bg-green-700 text-white px-4 py-2 rounded hover:bg-yellow-100 hover:text-teamtalk-blue font-bold transition duration-300 whitespace-nowrap">
                        Experimente grátis
                    </a>
                </div>
                @endauth
